...
#include "our_depth_rl_quadruped_controller/control/CtrlComponent.h"
#include "controller_common/FSM/StateFixedDown.h"
#include "our_depth_rl_quadruped_controller/FSM/StateFixedStand.h"
#include "controller_common//FSM/StatePassive.h"

namespace our_depth_rl_quadruped_controller
{
    struct FSMStateList
    {
