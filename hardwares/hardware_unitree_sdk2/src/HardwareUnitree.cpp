    ...
    const hardware_interface::HardwareInfo& info)
{
    ...
    RCLCPP_INFO(rclcpp::get_logger("unitree_hardware_sdk2"), " network_interface: %s, domain: %d", network_interface_.c_str(), domain_);
...
return_type HardwareUnitree::read(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
{
    ...
    if (show_foot_force_)
    {
        RCLCPP_INFO(rclcpp::get_logger("unitree_hardware_sdk2"),
                    "foot_force(): %f, %f, %f, %f",
